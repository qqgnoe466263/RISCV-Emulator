...
static void execution_r_type_instr(rv_emu_t *rv_emu)
{
     ...
     */
    uint8_t func3 = rv_emu->rv_cpu.func3;
    uint8_t func7 = rv_emu->rv_cpu.func7;
    uint32_t *rd_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rd];
    uint32_t *rs1_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rs1];
    uint32_t *rs2_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rs2];
...
static void execution_i_type_instr(rv_emu_t *rv_emu)
{
     ...
     * | imm  |  rs1  | func3 |  rd  | op |
     */
    uint8_t opcode = rv_emu->rv_cpu.opcode;
    uint8_t func3 = rv_emu->rv_cpu.func3;
    uint32_t imm = rv_emu->rv_cpu.imm;
    uint32_t *rd_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rd];
    uint32_t *rs1_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rs1];
...
{
    uint8_t func3 = rv_emu->rv_cpu.func3;
    uint32_t imm = rv_emu->rv_cpu.imm - 4; // TODO 
    uint32_t *rs1_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rs1];
    uint32_t *rs2_reg = &rv_emu->rv_cpu.xreg[rv_emu->rv_cpu.rs2];   
    uint32_t *pc = &rv_emu->rv_cpu.pc;
